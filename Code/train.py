from model.UFA.model_share import AF
import torch
import argparse
...
def train(train_loader,args):
    ...
    for epoch in range(0, n_epochs):
        ...
        for i, (image1,image2,label) in enumerate(train_loader):
            ...
            print("[epoch: %3d/%3d, batch: %5d/%5d] train loss: %8f " % (epoch + 1, n_epochs, (i + 1) * batch_size, train_num, loss.item()))
...
def parse_args():
    ...
    parser.add_argument('--saveModel_dir', type=str, default='experment_UFA/')
